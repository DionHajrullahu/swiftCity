    ...
    >
      ...
      <nav className="bg-[#0d2b3e] px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-none">Mr. International</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">
                          {rec.city}, {rec.country} · {cat.label}
                        </p>
                      </div>
                    ...
                    {rec.tips && (
                      <p className="text-xs text-[#3bbfb3] mt-1.5 flex items-center gap-1">
